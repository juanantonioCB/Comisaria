 ...
 * @author Juan Antonio
 */
public class GUILoad extends javax.swing.JFrame {

    /**
     * Creates new form GUILoad
     */
    public GUILoad() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUILoad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
